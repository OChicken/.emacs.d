;;; vscode-dark-theme.el --- Default Visual Studio Code Dark+ theme -*- lexical-binding: t; -*-

;; Copyright (C) 2020-2021 Ian Y.E. Pan

;; Author: Ian Y.E. Pan
;; URL: https://github.com/ianpan870102/vscode-dark-emacs-theme
;; Version: 0.0.0
...
(defcustom vscode-dark-render-line-highlight 'default
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(hl-line                                  ((,class ,(pcase vscode-dark-render-line-highlight
                                                          ((or 'line 'all)
   ...
   `(line-number-current-line                 ((,class (:inherit default :foreground ,line-num-current
                                                                 ,@(pcase vscode-dark-render-line-highlight
                                                                     ((or 'gutter 'all)
                                                                      `(:background ,bg1 :box (:color ,bg3 :line-width (0 . -1))))
                                                                     ((or 'none 'default)
                                                                      `(:background ,bg1)))))))
   ...
   `(org-level-1                              ((,class (:bold nil :foreground ,ms-bluegreen
                                                              ,@(when vscode-dark-scale-org-faces (list :height 1.1))))))
   ...
   `(org-todo                                 ((,class (,@(when vscode-dark-box-org-todo (list :box '(:line-width 1 :color ,ms-lightred)))
   ...
   `(org-agenda-date                          ((,class (:foreground ,var ,@(when vscode-dark-scale-org-faces (list :height 1.1))))))
   `(org-agenda-date-weekend                  ((,class (:weight normal :foreground ,fg4))))
   `(org-agenda-date-today                    ((,class (:weight normal :foreground ,keyword
                                                                ,@(when vscode-dark-scale-org-faces (list :height 1.2))))))
   ...
   `(org-document-title                       ((,class (:foreground ,type :bold t
                                                                    ,@(when vscode-dark-scale-org-faces (list :height 1.2)))))) ; title
   ...
   `(hl-todo                                  ((t ,@(when vscode-dark-invert-hl-todo (list :inverse-video t)))))
   ...
   `(highlight-thing                          ((t ,(pcase vscode-dark-render-line-highlight
